...
export default function RootLayout({ children }) {
  ...
  return (
    <html lang="fr">
      <Head>
        <title>TOUSKI est nécessaire pour son chez Soi. Site Officiel</title>
        <meta 
          name="description" 
          content="Nous sommes là pour votre confort à la maison et aux meilleurs prix" 
        />
        <meta property="og:title" content="TOUSKI est nécessaire pour son chez Soi. Site Officiel" />
        <meta 
