...
export default async function sitemap() {
  ...
  const staticRoutesFr = [
    ...
    { url: '/returns-and-refunds', priority: 0.6, changeFrequency: 'monthly' },
    { url: '/taxes-and-duties', priority: 0.6, changeFrequency: 'monthly' },
    { url: '/shipping-policy', priority: 0.6, changeFrequency: 'monthly' },
  ...
  const staticRoutesEn = [
    ...
    { url: '/en/returns-and-refunds', priority: 0.6, changeFrequency: 'monthly' },
    { url: '/en/taxes-and-duties', priority: 0.6, changeFrequency: 'monthly' },
    { url: '/en/shipping-policy', priority: 0.6, changeFrequency: 'monthly' },
  ...
  const staticRoutesDe = [
    ...
    { url: '/de/returns-and-refunds', priority: 0.6, changeFrequency: 'monthly' },
    { url: '/de/taxes-and-duties', priority: 0.6, changeFrequency: 'monthly' },
    { url: '/de/shipping-policy', priority: 0.6, changeFrequency: 'monthly' },
  ...
  const staticRoutesEs = [
    ...
    { url: '/es/returns-and-refunds', priority: 0.6, changeFrequency: 'monthly' },
    { url: '/es/taxes-and-duties', priority: 0.6, changeFrequency: 'monthly' },
    { url: '/es/shipping-policy', priority: 0.6, changeFrequency: 'monthly' },
