         ...
         <div className="container">
            <div className="position-relative">
               <div className="title-one mb-35 xl-mb-20 md-mb-10 wow fadeInUp">
                  {style ? (
                     <h3>Últimas <span>Noticias <Image src={titleShape} alt="" className="lazy-img" /></span></h3>
                  ) : (
                     <h2 className="font-garamond">Últimas Noticias</h2>
                  )}
                  <p className="fs-20 mt-xs">Descubre las novedades, consejos y tendencias de nuestros expertos.</p>
               </div>
