                  ...
                  {feature_listing_data
                     ...
                     >
                        <div className={`listing-card-four overflow-hidden d-flex align-items-end position-relative z-1 ${item.item_bg_img}`}>
                           {/* tag: aquí traducimos RENT/SELL */}
                           <div className="tag fw-500">
                              {item.tag === "RENT" ? "Renta" : item.tag === "SELL" ? "Venta" : item.tag}
                           </div>
                           ...
                           <div className="property-info tran3s w-100">
                              <div className="d-flex align-items-center justify-content-between">
                                 ...
                                 <Link href="/listing_details_04" className="btn-four inverse">
                                    <span>Ver más</span> <i className="bi bi-arrow-up-right"></i>
                                 </Link>
                              </div>
